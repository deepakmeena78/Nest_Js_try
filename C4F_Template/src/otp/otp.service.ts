...
export class OtpService {
  ...
  private getContextSmsParams(args: {
    ...
    switch (args.context) {
      case OtpContext.Auth:
        return {
          text: `Your one time verification code is ${args.code} to authenticate, Please do not share this code to anyone. This verification code will be expired after ${this.utilsService.msToHuman(args.timeout)}`,
        };
      case OtpContext.ResetPassword:
        return {
